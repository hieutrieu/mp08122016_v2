...
function mcImgSlider(k) {
    ...
    var l = new E, ob = function () {
        ...
        return a.join("")
    }, b = {a: 0, e: "", d: 0, c: 0, b: 0}, a, f, v, B, V, O, W, n, p, Z, K, t, H, J, s, hb, S, R, eb, e, I, m = null, Db = function () {
    ...
    ub.prototype = {
        c: function () {
            ...
            for (var f = 0, g = e < 7 ? {height: 0, opacity: -.4} : {width: 0, opacity: 0}, k = {height: B, opacity: 1}, a = 0, h = b[d]; a < h; a++) {
