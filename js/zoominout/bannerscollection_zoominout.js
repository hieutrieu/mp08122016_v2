...
(function (e) {
    ...
    function R(a, b, c) {
        ...
        -1 != p && 10 > p ? (a.stop().animate({opacity: m, left: f + "px", top: n + "px"}, 1E3 * a.attr("data-duration"), l, function () {
            a.css({
            ...
            void 0 != a.attr("data-intermediate-left") && "" != a.attr("data-intermediate-left") && (h = a.attr("data-intermediate-left"), g = a.attr("data-intermediate-top"), c.responsive && (h = parseInt(h / (c.origWidth / c.width), 10), g = parseInt(g / (c.origWidth / c.width), 10)), b.timeouts_arr[b.timeouts_arr.length] = setTimeout(function () {
                ...
                a.stop().animate({opacity: m, left: h + "px", top: g + "px"}, 1E3 * a.attr("data-intermediate-duration"), a.attr("data-intermediate-easing"), function () {
                    a.css({
                        "-webkit-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")",
                        "-moz-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")",
                        "-ms-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")",
            ...
            }, 1E3 * a.attr("data-intermediate-delay")), 8 == p && a.find("img:first").is("img") && a.find("img:first").animate({opacity: m}, 1E3 * a.attr("data-intermediate-duration"), a.attr("data-intermediate-easing"), function () {
            }))
    ...
    function Z(a, b, c, p) {
        ...
        c.each(function () {
            ...
            0 < l ? a.timeouts_arr[a.timeouts_arr.length] = setTimeout(function () {
                ...
                -1 != f && 10 > f ? (c.stop().animate({opacity: t, left: h + "px", top: g + "px"}, 1E3 * l, G, function () {
                    c.css({
                        "-webkit-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")",
                        "-moz-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")",
                        "-ms-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")",
                ...
                }), 8 == f && c.find("img:first").is("img") && c.find("img:first").animate({opacity: t}, 1E3 * l, G, function () {
                })) : c.css({
                    opacity: t,
                    "-webkit-transform": "translate(" + h + "px," + g + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")",
                    "-moz-transform": "translate(" + h + "px," + g + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")",
            ...
            }, 1E3 * p) : "false" == s && c.css({display: "none"});
            n++
        })
    }
    ...
    function L(a) {
        if (a)for (var b in a)a[b] && clearInterval(a[b]);
        a.length = 0
    }

    function $(a, b) {
        if (a)for (var c in a)a[c] && (a[c] = function () {
        });
        a.length = 0;
    ...
    function J(a, b, c, p, f, n, m, h, g, l, r, t, s, q, w, u) {
        ...
        y && !b.slideIsRunning && b.firstLoadingComplete && (b.slideIsRunning = !0, H(b.timeouts_arr), L(b.continuouseIntervalIDs), $(b.rotationFunctionsArr, b), Z(b, c, n, m), b.arcInitialTime = (new Date).getTime(), b.timeElapsed = 0, c.showCircleTimer && (clearInterval(b.intervalID), b.ctx.clearRect(0, 0, b.canvas.width, b.canvas.height), b.ctx.beginPath(), b.ctx.globalAlpha = c.behindCircleAlpha / 100, b.ctx.arc(c.circleRadius + 2 * c.circleLineWidth, c.circleRadius + 2 * c.circleLineWidth, c.circleRadius, 0, 2 * Math.PI, !1), b.ctx.lineWidth = c.circleLineWidth + 2, b.ctx.strokeStyle = c.behindCircleColor, b.ctx.stroke(), b.ctx.beginPath(), b.ctx.globalAlpha = c.circleAlpha / 100, b.ctx.arc(c.circleRadius + 2 * c.circleLineWidth, c.circleRadius + 2 * c.circleLineWidth, c.circleRadius, 0, 0, !1), b.ctx.lineWidth = c.circleLineWidth, b.ctx.strokeStyle = c.circleColor, b.ctx.stroke(), b.intervalID = setInterval(function () {
            ...
            "z-index": 1,
            display: "block"
        }), e("#contentHolderUnit_" + b.previous_current_img_no, g).animate({opacity: 0}, 1E3 * c.scrollSlideDuration, c.scrollSlideEasing, function () {
            b.slideIsRunning = !1;
    ...
    e.fn.bannerscollection_zoominout = function (a) {
        ...
        return this.each(function () {
            ...
            "opportune" == a.skin && (r.css({
                display: "block"/*, top: a.height-80 + "px"*/
            ...
            var s = e(".thumbsHolderWrapper", f), q = e(".thumbsHolderVisibleWrapper", f), w = e(".thumbsHolder", f), u, v;
            ...
            a.enableTouchScreen && (a.fadeSlides && (p = Math.floor(1E5 * Math.random()), f.wrap('<div id="zoominoutParent_' + p + '" style="position:relative;" />'), e("#zoominoutParent_" + p).width(a.width), e("#zoominoutParent_" + p).height(a.height)), -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || (h.css("cursor", "url(" + a.absUrl + "skins/hand.cur),url(" + a.absUrl + "skins/hand.cur),move"), f.css("cursor", "url(" + a.absUrl + "skins/hand.cur),url(" + a.absUrl + "skins/hand.cur),move")), h.css("left", "0"), a.fadeSlides ? -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || f.draggable({
                ...
                axis: "x", distance: 10, disabled: !0, start: function (a, b) {
                    origLeft = parseInt(e(this).css("left"), 10);
                    y.css("display", "none")
                }, stop: function (a, b) {
            ...
            var y = e(".playOver", f);
            y.css({left: parseInt((a.width - y.width()) / 2, 10) + "px", top: parseInt((a.height - y.height()) / 2, 10) + "px"});
            var d = {
                total_images: 0,
                current_img_no: 0,
                currentImg: 0,
            ...
            c = b.find("ul:first");
            d.total_images = 0;
            var z = c.children(), I, T = 0, F, O = 0, L = 0, A, x, U = 0, N = 0, R = '<img src="' + a.absUrl + 'skins/empty.png" alt="" width="1" height="1" />';
            z.each(function () {
                d.currentImg = e(this);
                ...
                if (d.currentImg.is("li")) {
                    ...
                    a.fadeSlides ? I.css({position: "absolute", top: 0, left: 0, "z-index": myzindex, display: mydisplay}) : I.css({position: "relative", "float": "left"});
                    I.width(a.width);
                    I.height(a.height);
                    h.append(I);
                    T += a.width;
                    ...
                    e(d.currentImg.attr("data-text-id")).css({width: b.width() + "px", left: N, top: n.css("top")});
                    var c = -1;
            ...
            f.mouseenter(function () {
                ...
                }) : 0 > a.thumbsWrapperMarginTop && d.isVideoPlaying || !a.showBottomNav || (s.css({display: "block"}), s.stop().animate({opacity: 1}, 500, "swing", function () {
                })))
            });
            f.mouseleave(function () {
                ...
                a.autoHideBottomNav && a.showBottomNav && ("opportune" == a.skin ? r.css("display", "none") : s.stop().animate({opacity: 0}, 300, "swing", function () {
                }));
            ...
            "opportune" == a.skin && (C.click(function () {
                ...
                if (a.showPreviewThumbs) {
                    ...
                    b.append(t);
                    var d = e(z[c]).attr("data-bottom-thumb"), f = e(z[H]).attr("data-bottom-thumb"), g = 80, h = -80;
                    H > c && (g = -80, h = 80);
                    t.html("");
